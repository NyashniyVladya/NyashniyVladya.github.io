...
1. ### О режимах работы.
    ...
    * #### Наилучший (оптимальный для комфортного чтения) вариант использования следующий:
        ...
        1. Запустить новеллу с **де**активированными параметрами [___prescanOnStartup___](../settingDescription/RU.md#prescanonstartup-) и [___realtimeTranslationOnStartup___](../settingDescription/RU.md#realtimetranslationonstartup-).
        ...
        1. Приостановить предварительное сканирование тем же пунктом, которым оно было запущено ранее.
